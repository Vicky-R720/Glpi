...
SC_NUMPAD0 = 82   # touche 0/Inser du pavé num → toggle minimize/restore
SC_NUMPAD8 = 72
SC_NUMPAD2 = 80
SC_NUMPAD4 = 75
SC_NUMPAD6 = 77
NUMPAD_SCANCODES = {SC_NUMPAD8, SC_NUMPAD2, SC_NUMPAD4, SC_NUMPAD6}
...
class NumpadScrollHook:
    ...
    _SCAN_TO_SCROLL = {
        SC_NUMPAD8: (WM_MOUSEWHEEL,  +WHEEL_DELTA),
        SC_NUMPAD2: (WM_MOUSEWHEEL,  -WHEEL_DELTA),
        SC_NUMPAD4: (WM_MOUSEHWHEEL, -WHEEL_DELTA),
        SC_NUMPAD6: (WM_MOUSEHWHEEL, +WHEEL_DELTA),
    }
